...
1. Произведем первоначальную настройку наших активных устройств R1, S1, S2, настроив доступ и авторизацию по консоли и по VTY, установим пароли, время и приветственный баннер, а также отключим поиск DNS. Произведем настройку на примере маршрутизатора R1:
2. 
