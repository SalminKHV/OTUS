...
​	1. [Произведем первоначальную настройку: ](#1. Произведем первоначальную настройку )

​		[Команды первоначальной настройки устройств: ](#Команды первоначальной настройки устройств: )

 2. [Настройка роутера R1:](#2. Настройка роутера R1:)

 3. [Настройка коммутатора S1:](#3. Настройка коммутатора S1:)

 4. [Настройка коммутатора S2:](#4. Настройка коммутатора S2:)
